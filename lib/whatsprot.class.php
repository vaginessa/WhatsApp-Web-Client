...
class WhatsProt
{
    ...
    const WHATSAPP_VER = '2.11.372';                // The WhatsApp version.
    const WHATSAPP_USER_AGENT = 'WhatsApp/2.11.372 Android/4.3 Device/GalaxyS3';// User agent used in request/registration code.
